...
class CastMoviesScreen extends StatefulWidget {
  const CastMoviesScreen({super.key});

  @override
  State<CastMoviesScreen> createState() => _CastMoviesScreenState();
}

class _CastMoviesScreenState extends State<CastMoviesScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Tom Cruise Movies'),
        backgroundColor: AppColors.colorSecondaryDarkest,
        elevation: 0,
        actions: const [
          Padding(
